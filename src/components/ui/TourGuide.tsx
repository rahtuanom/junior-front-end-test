...
export const TourGuide: React.FC<TourGuideProps> = ({
  ...
  const tourSteps = [
    ...
    },
    {
      ...
      icon: <ArrowRight className="w-6 h-6 text-brand-600" />,
      ...
      <div className="space-y-5">
        ...
        <div className="flex items-center justify-between pb-3 border-b border-slate-100">
          <div className="flex items-center gap-2.5">
            ...
            <div>
              <h2 className="text-base sm:text-lg font-bold text-navy-900">Panduan Simulasi Workflow</h2>
        ...
        {/* Step Indicator */}
        <div className="flex items-center justify-between gap-2 bg-navy-50 p-3 rounded-xl border border-[#C5C5D3]">
          {tourSteps.map((s) => (
            <div
              key={s.step}
        ...
        <div className="bg-white border border-[#C5C5D3] rounded-2xl p-5 space-y-3 shadow-2xs">
          <div className="flex items-center gap-3">
            ...
            <h3 className="font-bold text-sm sm:text-base text-navy-900">{currentInfo.title}</h3>
          </div>
          ...
          <div className="bg-navy-50 border border-[#DDE9FF] p-3 rounded-xl text-xs text-navy-900 font-semibold flex items-center gap-2">
